...
int main(int argc, char **argv){
	...
	if(rank==0){
...
#ifdef INCLUDE_MPI		
		AutomataMPI automata(size, rank, maxCells, seed, spaceSize, spaceSize, spaceSize, cellRadius, {tumorRadius,a,b,p0,gamma,xDegradation,muMotility});
#else
		...
		AutomataMPI automata(size, rank);
	}
	MPI_Finalize();
#endif
